...
$userprofile = isset($_SESSION['email']) ? $_SESSION['email'] : false;
    ...
    <main>
        <div class="card-container">
            <div class="card">
                ...
                <img src="images/complete_registration.webp" style="height: 50px; margin-bottom: 20px; margin-top: 20px;">
                <br>
                <a href="Complete_reg.php"><button>Complete Registration</button></a>
            </div>
            <div class="card">
                <h2>Check Registration Details</h2>
                <img src="images/check_your_details.webp" style="height: 50px; margin-bottom: 10px; margin-top: 20px;">
                <br>
                <a href="Check_your_details.php"><button>Check Details</button></a>
            </div>
            <div class="card">
                <h2>Feedback</h2>
                <img src="images/feedback.webp" style="height: 50px; margin-bottom: 20px; margin-top: 20px;">
                <br>
                <a href="User_feedback.php"><button>Give Feedback</button></a>
            </div>
        </div>
    </main>  
</body>
