    ...
    <main>
        <div class="card-container">
            <div class="card">
                ...
                <img src="images/check_your_details.webp" style="height: 50px; margin-bottom: 20px; margin-top: 20px;">
                <br>
                <a href="admin_check_details.webp"><button>View Details</button></a>
            </div>
            <div class="card">
                <h2>Feedback</h2>
